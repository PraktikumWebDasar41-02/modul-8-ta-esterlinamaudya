        ...
        <table>
            ...
            <tr>
             ...
             <tr>
                ...
                <td>:</td>
                <td> 
                    <input type="checkbox" name="hobbi[]" value="Bersepeda"
                    <?php if(array_search("Nonton", $sohobi) > -1 ) { echo "checked"; }?>>Bersepeda<br>
                    <input type="checkbox" name="hobbi[]" value="Berenang"
                    <?php if(array_search("Baca", $sohobi) > -1 ) { echo "checked"; }?>>Berenang<br>
                    <input type="checkbox" name="hobbi[]" value="Bercanda"
                    <?php if(array_search("Travelling", $sohobi) > -1 ) { echo "checked"; }?>>Bercanda<br> 
                </td>
            </tr>
            <tr>
                <td>Genre Film</td>
